...
/**
 * @minions-services/cli — CLI for Minions Services
 *
...
import { customTypes } from '@minions-services/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Services'));
        console.log(chalk.dim('Service catalog, packages, pricing tiers, case studies, and target industries'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-services/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-services/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-services')}`);
