# Manual Setup Steps for Minions Services
...
Go to **GitHub → mxn2020/minions-services → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-services` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-services-web`
- **GitHub repo**: `mxn2020/minions-services`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `services.minions.wtf`

### Documentation
- **Netlify site name**: `minions-services-docs`
- **GitHub repo**: `mxn2020/minions-services`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `services.minions.help`

### Blog
- **Netlify site name**: `minions-services-blog`
- **GitHub repo**: `mxn2020/minions-services`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `services.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `services.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `services.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `services.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-services/sdk`](https://www.npmjs.com/package/@minions-services/sdk)
- CLI: [`@minions-services/cli`](https://www.npmjs.com/package/@minions-services/cli)
...
Your package: [`minions-services`](https://pypi.org/project/minions-services/)
...
| Item | Value |
|------|-------|
| Project | `minions-services` |
| SDK (npm) | `@minions-services/sdk` |
| CLI (npm) | `@minions-services/cli` |
| Python (PyPI) | `minions-services` |
| GitHub | `github.com/mxn2020/minions-services` |
| Docs domain | `services.minions.help` |
| Blog domain | `services.minions.blog` |
| App domain | `services.minions.wtf` |
